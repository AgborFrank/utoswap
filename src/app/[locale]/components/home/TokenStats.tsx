...
export default function TokenStats() {
  const t = useTranslations("common.home.stats");
  ...
  return (
    ...
    >
      <div className="flex md:flex-row flex-col gap-20">
        ...
        <div className="md:w-1/2 w-full">
          ...
          <div className="pt-20">
            ...
            <div className="cta mt-6">
              <Link
                href="#"
                className="text-lg font-bold bg-cta/10 text-cta py-3 px-6 rounded-full"
              >
                {t("cta")}
              </Link>
            </div>
        ...
        {/* Right Side - Grid with Staggered Animation */}
        <div className="md:w-1/2 w-full">
